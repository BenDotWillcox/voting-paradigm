...
**Next, in order:**
1. Implement provider adapters and qualify exactly three open-weight candidates
   on public development data within the USD 4 qualification cap
