...
2. Construct and review the paid capability-preflight authorization against
   the v2 catalog and no-spend readiness hashes
3. After separate spend approval, run the 15 public-development capability
   probes and require all three candidates to pass all five role contracts
